...
goog.defineClass.applyProperties_=function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c]);for(var d=0;d<goog.defineClass.OBJECT_PROTOTYPE_FIELDS_.length;d++)c=goog.defineClass.OBJECT_PROTOTYPE_FIELDS_[d],Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c])};goog.tagUnsealableClass=function(a){!COMPILED&&goog.defineClass.SEAL_CLASS_INSTANCES&&(a.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_]=!0)};goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_="goog_defineClass_legacy_unsealable";var scaffold={controllers:{}};scaffold.controllers.DemoController=function(a,b,c){this.$element=a;this.$http=c;this.$scope=b;this.text=null};scaffold.controllers.DemoController.$inject=["$element","$scope","$http"];scaffold.controllers.DemoController.prototype.sayHello=function(a){this.$element[0].querySelector("button").textContent=a};goog.exportSymbol("scaffold.controllers.DemoController.prototype.sayHello",scaffold.controllers.DemoController.prototype.sayHello);scaffold.main=function(){angular.module("scaffold",[]).controller("DemoController",scaffold.controllers.DemoController);angular.bootstrap(document,["scaffold"])};goog.exportSymbol("scaffold.main",scaffold.main); })();
